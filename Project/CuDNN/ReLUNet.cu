...
struct TrainingContext
{
    ...
    cudnnTensorDescriptor_t dataTensor, conv1Tensor, conv1BiasTensor, pool1Tensor, 
                             conv2Tensor, conv2BiasTensor, pool2Tensor, fc1Tensor, conv1reluTensor, conv2reluTensor, fc2Tensor;
    ...
    cudnnActivationDescriptor_t conv1Activation, conv2Activation, fc1Activation;
                    ...
                    FullyConnectedLayer& fc1, FullyConnectedLayer& fc2) : ref_fc1(fc1), ref_fc2(fc2), m_gpuid(gpuid)
    {
        ...
        checkCUDNN(cudnnCreateTensorDescriptor(&conv1reluTensor));
        checkCUDNN(cudnnCreateTensorDescriptor(&conv2reluTensor));
        ...
        checkCUDNN(cudnnCreateActivationDescriptor(&conv2Activation));
        ...
        checkCUDNN(cudnnSetTensor4dDescriptor(conv1BiasTensor,
                                              ...
                                              1, 1));
        checkCUDNN(cudnnSetTensor4dDescriptor(conv1reluTensor,
                                              CUDNN_TENSOR_NCHW,
                                              CUDNN_DATA_FLOAT,
                                              1, conv1.out_channels,
                                              1, 1));
                                              
        checkCUDNN(cudnnSetTensor4dDescriptor(conv2reluTensor,
                                              CUDNN_TENSOR_NCHW,
                                              CUDNN_DATA_FLOAT,
                                              1, conv1.out_channels,
                                              1, 1));
        ...
        checkCUDNN(cudnnSetActivationDescriptor(conv1Activation, CUDNN_ACTIVATION_RELU,
                                                CUDNN_PROPAGATE_NAN, 0.0));
                                                
        checkCUDNN(cudnnSetActivationDescriptor(conv2Activation, CUDNN_ACTIVATION_RELU,
                                                CUDNN_PROPAGATE_NAN, 0.0));
    ...
    ~TrainingContext()
    {
        ...
        checkCUDNN(cudnnDestroyActivationDescriptor(conv2Activation));
    ...
    void ForwardPropagation(float *data, float *conv1,  float *conv1relu, float *conv2relu, float *pool1, float *conv2, float *pool2, float *fc1, float *fc1relu, 
    ...
    {        
        ...
        // ReLU-1 activation
        checkCUDNN(cudnnActivationForward(cudnnHandle, conv1Activation, &alpha,
                                          conv1Tensor, conv1, &beta, conv1Tensor, conv1relu));
        ...
        // ReLU-2 activation
        checkCUDNN(cudnnActivationForward(cudnnHandle, conv2Activation, &alpha,
                                          conv2Tensor, conv2, &beta, conv2Tensor, conv2relu));
    ...
    void Backpropagation(ConvBiasLayer& layer_conv1, MaxPoolLayer& layer_pool1, ConvBiasLayer& layer_conv2, MaxPoolLayer& layer_pool2,
                         float *data, float *labels, float *conv1, float *pool1, float *conv2, float *pool2, float *fc1, float *conv1relu, float *conv2relu, float *fc1relu,
                         ...
                         float *gfc1, float *gfc1bias, float *dfc1, float *dconv1relu, float *dconv2relu, float *dfc1relu, 
    ...
    {    
        ...
        checkCUDNN(cudnnPoolingBackward(cudnnHandle, poolDesc, &alpha, 
                                        ...
                                        conv2reluTensor, conv2relu, &beta, conv2reluTensor, dpool2));
                                        
        // ReLU-2 activation
        checkCUDNN(cudnnActivationBackward(cudnnHandle, conv2Activation, &alpha,
                                           conv2Tensor, conv2relu, conv2Tensor, dpool2,
                                           conv2Tensor, conv2, &beta, conv2Tensor, dconv2relu));
        ...
        checkCUDNN(cudnnPoolingBackward(cudnnHandle, poolDesc, &alpha, 
                                        ...
                                        conv1reluTensor, conv1relu, &beta, conv1reluTensor, dpool1));
        
        // ReLU-1 activation
        checkCUDNN(cudnnActivationBackward(cudnnHandle, conv1Activation, &alpha,
                                           conv1Tensor, conv1relu, conv1Tensor, dpool1,
                                           conv1Tensor, conv1, &beta, conv1Tensor, dconv1relu));
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    float *d_data, *d_labels, *d_conv1,*d_conv1relu, *d_conv2relu, *d_pool1, *d_conv2, *d_pool2, *d_fc1, *d_fc1relu, *d_fc2, *d_fc2smax;
    ...
    checkCudaErrors(cudaMalloc(&d_conv1relu, sizeof(float) * context.m_batchSize * conv1.out_channels * conv1.out_height                  * conv1.out_width));
    ...
    checkCudaErrors(cudaMalloc(&d_conv2relu, sizeof(float) * context.m_batchSize * conv2.out_channels * conv2.out_height                  * conv2.out_width));
    ...
    float *d_dpool1, *d_dpool2, *d_dconv2, *d_dfc1, *d_dfc1relu,*d_dconv1relu, *d_dconv2relu, *d_dfc2, *d_dfc2smax, *d_dlossdata;
    //                         Buffer     | Element       | N                   | C                  | H                                 | W
    //-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    checkCudaErrors(cudaMalloc(&d_dconv1relu, sizeof(float) * context.m_batchSize * conv1.out_channels * conv1.out_height                  * conv1.out_width));
    checkCudaErrors(cudaMalloc(&d_dconv2relu, sizeof(float) * context.m_batchSize * conv2.out_channels * conv2.out_height                  * conv2.out_width));
    ...
    for (int iter = 0; iter < FLAGS_iterations; ++iter)
    {
        ...
        // Forward propagation
        context.ForwardPropagation(d_data, d_conv1, d_conv1relu, d_conv2relu, d_pool1, d_conv2, d_pool2, d_fc1, d_fc1relu, d_fc2, d_fc2smax, 
        ...
        context.Backpropagation(conv1, pool1, conv2, pool2,
                                d_data, d_labels, d_conv1, d_pool1, d_conv2, d_pool2, d_fc1, d_conv1relu, d_conv2relu, d_fc1relu, d_fc2, d_fc2smax, d_dlossdata,
                                d_pconv1, d_pconv1bias, d_pconv2, d_pconv2bias, d_pfc1, d_pfc1bias, d_pfc2, d_pfc2bias,
                                d_gconv1, d_gconv1bias, d_dpool1, d_gconv2, d_gconv2bias, d_dconv2, d_dpool2, d_gfc1, d_gfc1bias, 
                                d_dfc1, d_dconv1relu, d_dconv2relu, d_dfc1relu, d_gfc2, d_gfc2bias, d_dfc2, d_cudnn_workspace, d_onevec);
    ...
    if (classifications > 0)
    {
        ...
        for (int i = 0; i < classifications; ++i)
        {
            ...
            test_context.ForwardPropagation(d_data, d_conv1, d_conv1relu, d_conv2relu, d_pool1, d_conv2, d_pool2, d_fc1, d_fc1relu, d_fc2, d_fc2smax,
